...
local autocmd = require("user.auto").autocmd
...
local inlays = require "user.lsp.inlay"
...
local filetype_attach = setmetatable({
  ocaml = function()
    ...
    autocmd {
      ...
      augroup_codelens,
      require("user.lsp.codelens").refresh_virtlines,
      0,
    }
    ...
    vim.keymap.set(
      "n",
      "<space>tt",
      require("user.lsp.codelens").toggle_virtlines,
...
local servers = {
  ...
  yamlls = true,
  -- ocamllsp = {
  --   cmd = { "/home/user/git/ocaml-lsp/_build/default/ocaml-lsp-server/bin/main.exe" },
  --   settings = {
